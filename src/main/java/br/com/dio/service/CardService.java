...
public record CardService(Connection connection) {
    ...
    public void moveToNextColumn(final Long cardId, final List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException {
        try {
            var result = verification(cardId, boardColumnsInfo);
            var dao = (CardDAO) result.getFirst();
            var currentColumn = (BoardColumnInfoDTO) result.getLast();
    ...
    private List<Object> verification(Long cardId, final List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException {
        var dao = new CardDAO(connection);
        ...
        var daoAndBoard = new ArrayList<>();
        daoAndBoard.add(dao);
        daoAndBoard.add(currentColumn);
        return daoAndBoard;
    }
